...
export default {
    ...
    methods: {
        search() {
            ...
            axios.get(`http://localhost/buku-backend/selectAnggotabyNomor.php?nomor=${number}`)
                .then(response => {
        ...
        getAnggotaList() {
            axios.get('http://localhost/buku-backend/selectAnggota.php')
                .then(response => {
        ...
        submitForm() {
            if (this.mode === 'tambah') {
                axios.post('http://localhost/buku-backend/insertAnggota.php', this.anggota)
                    .then(response => {
                ...
                axios.put('http://localhost/buku-backend/updateAnggotabyNomor.php' + this.anggota.nomor, this.anggota)
                    .then(response => {
                        console.log(response.data);
        ...
        hapusAnggota(nomor) {
            axios.delete('http://localhost/buku-backend/deleteAnggotabyNomor.php' + nomor)
                .then(response => {
                    console.log(response.data);
